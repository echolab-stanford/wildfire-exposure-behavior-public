...
if (!dir.exists(path_era5_temperature_grid)) dir.create(path_era5_temperature_grid)
...
stack1 <- stack(file.path(path_era5_temperature, "era5_2006-2010_2m_daily_temp.nc"))
stack2 <- stack(file.path(path_era5_temperature, "era5_2011-2015_2m_daily_temp.nc"))
stack3 <- stack(file.path(path_era5_temperature, "era5_2016-2020_2m_daily_temp.nc"))
...
for (grid_year in grid_years) {
  ...
  saveRDS(temperature, file.path(path_era5_temperature_grid, paste0("grid_temperature_", grid_year, ".rds")))
}
