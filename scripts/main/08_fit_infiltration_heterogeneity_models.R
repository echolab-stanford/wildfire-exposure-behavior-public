...
# Written by: Jessica Li
#-------------------------------------------------------------------------------
if (!file.exists(file.path(path_infiltration, "heterogeneity", "models", 
                           paste0("models_", pm_method, "_RF.rds")))) {
  ...
  # Save all models
  saveRDS(mdls, file.path(path_infiltration, "heterogeneity", "models", "models.rds"))
}
...
#-------------------------------------------------------------------------------
if (!file.exists(file.path(path_infiltration, "heterogeneity", "models", 
                           paste0("models_", pm_method, "_GBT.rds")))) {
  # Read in train and test data
  dat_train <- readRDS(file.path(path_infiltration, "heterogeneity", pm_path, post_path, "dat_train.rds"))
  dat_test <- readRDS(file.path(path_infiltration, "heterogeneity", pm_path, post_path, "dat_test.rds"))
